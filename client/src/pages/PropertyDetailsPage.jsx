...
import { inquiryService, propertyService } from '../services/store';
...
export default function PropertyDetailsPage() {
  ...
  useEffect(() => {
    setPayload(propertyService.byId(id));
  }, [id]);

  if (!payload?.property) return <section className="container-x py-10">Property not found.</section>;
